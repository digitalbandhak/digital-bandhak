-- ═══════════════════════════════════════════════════════════════════
-- Digital Bandhak - TABLES ONLY (agar database pehle se exist karta hai)
-- phpMyAdmin mein: digitalbandhak select karo > Import > yeh file
-- ═══════════════════════════════════════════════════════════════════
...
ALTER TABLE shops ADD COLUMN IF NOT EXISTS photo VARCHAR(255) DEFAULT NULL;
...
-- Admin insert (only if not exists)
